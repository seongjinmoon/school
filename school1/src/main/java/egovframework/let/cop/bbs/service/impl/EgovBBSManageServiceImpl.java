...
public class EgovBBSManageServiceImpl extends EgovAbstractServiceImpl implements EgovBBSManageService {
     ...
     * 게시물 한 건을 삭제 한다.
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#deleteBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#insertBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#selectBoardArticle(egovframework.let.cop.bbs.ReservationVO.service.BoardVO)
     */
     ...
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#selectBoardArticles(egovframework.let.cop.bbs.ReservationVO.service.BoardVO)
     */
     ...
     * 게시물 한 건의 내용을 수정 한다.
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#updateBoardArticle(egovframework.let.cop.bbs.brd.service.Board)
     */
     ...
     * 방명록 내용을 삭제 한다.
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#deleteGuestList(egovframework.let.cop.bbs.ReservationVO.service.BoardVO)
     */
     ...
     * 방명록에 대한 목록을 조회 한다.
     *
     * @see egovframework.let.cop.bbs.ReservationService.service.EgovBBSManageService#selectGuestList(egovframework.let.cop.bbs.ReservationVO.service.BoardVO)
     */
